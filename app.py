...
def create_admin_user():
    ...
    admin = {
        'id': 1,
        'username': '@chihab2088',
        'password': hash_password('@chihab2088'),
        'max_bots': 999999,
    ...
    admin_folder = os.path.join(USERS_STORAGE, "admin_chihab")
    ...
    print("👤 اسم المستخدم: @chihab2088")
    print("🔑 كلمة المرور: @chihab2088")
    print("="*50)
...
def check_admin_exists():
    ...
    for user in users:
        if user.get('username') == '@chihab2088' and user.get('is_admin'):
            print("="*50)
